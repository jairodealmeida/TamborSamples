            ...
            for (Field field : fields) {
                ...
                if (annoField != null && annoField instanceof GPAField) {
                    ...
                    if (type instanceof String) {
                        result.add(new FieldTO(name, c.getString(c.getColumnIndexOrThrow(name))));
                    }
                    if (type instanceof Integer) {
                        result.add(new FieldTO(name, c.getInt(c.getColumnIndexOrThrow(name))));
                    }
                    ...
                    if (type instanceof Double) {
                        result.add(new FieldTO(name, c.getDouble(c.getColumnIndexOrThrow(name))));
                    }
                    if (type instanceof Float) {
                        result.add(new FieldTO(name, c.getFloat(c.getColumnIndexOrThrow(name))));
                    }
                    if (type instanceof byte[]) {
                        result.add(new FieldTO(name, c.getBlob(c.getColumnIndexOrThrow(name))));
                    }
                    if (type instanceof Short) {
                        result.add(new FieldTO(name, c.getShort(c.getColumnIndexOrThrow(name))));
                    }
                    continue;
                }
