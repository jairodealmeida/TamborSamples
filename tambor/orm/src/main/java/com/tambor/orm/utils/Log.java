...
public class Log{
	...
	public static void e(AppCompatActivity activity, String message){
		e(activity, message,null);
	}
	public static void e(AppCompatActivity activity, Exception e){
		e(activity, e.getLocalizedMessage(),e);
	}	
	public static void e(AppCompatActivity activity, String message, Exception e){
		if(activity!=null){
			init(activity);
	...
	public static void i(AppCompatActivity activity, String message){
		if(activity!=null){
			init(activity);
	...
	public static File getLogCatFile(AppCompatActivity context){
		init(context);
	    return outputFile;
	}
}
