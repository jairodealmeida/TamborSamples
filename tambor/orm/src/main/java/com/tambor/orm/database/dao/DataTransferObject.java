package com.tambor.orm.database.dao;


import com.tambor.orm.database.DatabaseDAOImpl;
...
public class DataTransferObject extends DatabaseDAOImpl {
    ...
    private final Map<Integer, String> transaction = new HashMap<Integer, String>();
     ...
     * @throws SQLException TODO modify ArrayList<TransferObject> to TransferObjectColection implemented to easy-gpa
     */
